...
namespace QuanLyKhachHang.Views
{
    public class TrangChuView : UserControl
    {
        ...
        {
            // Điền sẵn số điện thoại vừa gõ ở ô tìm kiếm vào popup Thêm khách hàng,
            // người dùng không cần gõ lại số điện thoại lần thứ 2.
            var cuaSo = new KhachHangEditWindow(_data.TaoMaKhachHangMoi(), sdtMacDinh: _txtTimSdt.Text?.Trim());
